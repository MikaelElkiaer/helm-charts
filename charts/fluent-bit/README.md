...
| `config.parser`          | The parser to use (docker,cri) - sets the parser key in the [INPUT] section. Besides the default parsers, this can also refer to parsers defined via `config.parsers`.                                                                                    | `docker`                         |
